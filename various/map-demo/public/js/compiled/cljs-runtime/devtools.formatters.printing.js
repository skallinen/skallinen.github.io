...
var G__35057 = (i__4819__auto___35056 + (1));
i__4819__auto___35056 = G__35057;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq34991){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34992,G__34993,seq34991__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__35014_SHARP_){
return (!((cljs.core.meta(p1__35014_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35026__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e35028){var _e__33803__auto__ = e35028;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e35031){var _e__33803__auto__ = e35031;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__35038 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__35039 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__35039);

try{var map__35040 = opts;
var map__35040__$1 = cljs.core.__destructure_map(map__35040);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35040__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__35038);
}});
...
var temp__5751__auto___35069 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___35069)){
var managed_print_level_35070 = temp__5751__auto___35069;
var _STAR_print_level_STAR__orig_val__35046_35071 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__35047_35072 = managed_print_level_35070;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__35047_35072);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__35042_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__35042_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__35046_35071);
}} else {
job_fn();
}
