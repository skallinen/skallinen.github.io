...
var vec__52782 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__52787 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52787,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52787,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52782,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52782,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__52816){
var vec__52817 = p__52816;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52817,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52817,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52823,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52823,(1),null);
...
var vec__52838 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52838,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52838,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52838,(2),null);
var vec__52841 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52841,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52841,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52841,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__52875){
var vec__52876 = p__52875;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52876,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52876,(1),null);
...
var vec__52882 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52882,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52882,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52882,(2),null);
...
var vec__52906 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52906,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52906,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52906,(2),null);
var tuple = vec__52906;
...
var G__53112 = cljs.core.next(style_vec);
var G__53113 = ends_w_blanks_QMARK_;
var G__53114 = tuple;
var G__53115 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__53112;
previous_ends_w_blanks_QMARK_ = G__53113;
previous_tuple = G__53114;
out = G__53115;
continue;
}
break;
...
var len__4818__auto___53118 = arguments.length;
var i__4819__auto___53119 = (0);
while(true){
if((i__4819__auto___53119 < len__4818__auto___53118)){
args__4824__auto__.push((arguments[i__4819__auto___53119]));

var G__53121 = (i__4819__auto___53119 + (1));
i__4819__auto___53119 = G__53121;
continue;
} else {
}
break;
...
var vec__52916 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52916,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52916,(1),null);
...
var result = (function (){var G__52919 = zprint.core.parse_string_all_options(rest_options);
var G__52920 = zprint.core.zprint_str_internal;
var G__52921 = ":parse-string-all? call";
var G__52922 = (function (){var G__52923 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52923) : zprint.zutil.edn_STAR_.call(null,G__52923));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__52919,G__52920,G__52921,G__52922) : zprint.core.process_multiple_forms.call(null,G__52919,G__52920,G__52921,G__52922));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__52928 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52928,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52928,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq52909){
var G__52910 = cljs.core.first(seq52909);
var seq52909__$1 = cljs.core.next(seq52909);
var G__52911 = cljs.core.first(seq52909__$1);
var seq52909__$2 = cljs.core.next(seq52909__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52910,G__52911,seq52909__$2);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___53156 = arguments.length;
var i__4819__auto___53157 = (0);
while(true){
if((i__4819__auto___53157 < len__4818__auto___53156)){
args__4824__auto__.push((arguments[i__4819__auto___53157]));

var G__53158 = (i__4819__auto___53157 + (1));
i__4819__auto___53157 = G__53158;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq52935){
var G__52936 = cljs.core.first(seq52935);
var seq52935__$1 = cljs.core.next(seq52935);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52936,seq52935__$1);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___53159 = arguments.length;
var i__4819__auto___53161 = (0);
while(true){
if((i__4819__auto___53161 < len__4818__auto___53159)){
args__4824__auto__.push((arguments[i__4819__auto___53161]));

var G__53163 = (i__4819__auto___53161 + (1));
i__4819__auto___53161 = G__53163;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq52937){
var G__52938 = cljs.core.first(seq52937);
var seq52937__$1 = cljs.core.next(seq52937);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52938,seq52937__$1);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___53167 = arguments.length;
var i__4819__auto___53168 = (0);
while(true){
if((i__4819__auto___53168 < len__4818__auto___53167)){
args__4824__auto__.push((arguments[i__4819__auto___53168]));

var G__53169 = (i__4819__auto___53168 + (1));
i__4819__auto___53168 = G__53169;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq52939){
var G__52940 = cljs.core.first(seq52939);
var seq52939__$1 = cljs.core.next(seq52939);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52940,seq52939__$1);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___53171 = arguments.length;
var i__4819__auto___53172 = (0);
while(true){
if((i__4819__auto___53172 < len__4818__auto___53171)){
args__4824__auto__.push((arguments[i__4819__auto___53172]));

var G__53173 = (i__4819__auto___53172 + (1));
i__4819__auto___53172 = G__53173;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq52943){
var G__52944 = cljs.core.first(seq52943);
var seq52943__$1 = cljs.core.next(seq52943);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52944,seq52943__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__52963,form){
var vec__52964 = p__52963;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52964,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52964,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52964,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52964,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__52970 = (cljs.core.truth_((function (){var and__4210__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4210__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52970,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52970,(1),null);
...
var G__53199 = cljs.core.next(sos);
var G__53200 = comment_QMARK_;
var G__53201 = (function (){var or__4212__auto__ = (!(empty_string_QMARK_));
if(or__4212__auto__){
return or__4212__auto__;
} else {
...
var G__53202 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__53199;
previous_comment_QMARK_ = G__53200;
start_interpolating_QMARK_ = G__53201;
out = G__53202;
continue;
}
break;
...
try{var vec__53011 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53011,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53011,(1),null);
...
var vec__53014 = (cljs.core.truth_((function (){var or__4212__auto__ = range_start__$1;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53014,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53014,(1),null);
...
var vec__53017 = (cljs.core.truth_((function (){var and__4210__auto__ = actual_start;
if(cljs.core.truth_(and__4210__auto__)){
return actual_end;
} else {
return and__4210__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53017,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53017,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53017,(2),null);
...
var forms = (function (){var G__53033 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__53033) : zprint.zutil.edn_STAR_.call(null,G__53033));
})();
