...
var G__46850 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__46850;
continue;
} else {
var G__46851 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__46851;
continue;
}
} else {
var G__46853 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__46853;
continue;
}
}
...
var G__46816 = zloc;
var G__46817 = (function (){var G__46818 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__46819 = zloc;
var G__46819__$1 = (((G__46819 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__46819) : rewrite_clj.zip.node.call(null,G__46819)));
if((G__46819__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__46819__$1) : zprint.zutil.edn_STAR_.call(null,G__46819__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__46818) : rewrite_clj.zip.root.call(null,G__46818));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__46816,G__46817) : rewrite_clj.zip.replace.call(null,G__46816,G__46817));
});
/**
...
var G__46860 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__46860;
continue;
}
break;
...
var G__46861 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__46862 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__46861;
out = G__46862;
continue;
} else {
...
var G__46863 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__46864 = cljs.core.next(new_loc);
var G__46865 = replaced_loc;
nloc = G__46863;
new_loc = G__46864;
last_loc = G__46865;
continue;
...
return zprint.rewrite.sort_val((function (){var G__46840 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__46840) : rewrite_clj.zip.down.call(null,G__46840));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__46841_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__46841_SHARP_) : rewrite_clj.zip.tag.call(null,p1__46841_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__46841_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__46841_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
