...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_51099 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_51099(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_51103 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_51103(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_51105 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_51105(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_51110 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_51110(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_51112 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_51112(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_51115 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_51115(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_51118 = (function (this$,header){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_51118(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_51122 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_51122(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_51125 = (function (this$,request){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_51125(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_51127 = (function (this$,response){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_51127(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k50999,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k50999,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__51012){
var vec__51013 = p__51012;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51013,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51013,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__50998){
var self__ = this;
var G__50998__$1 = this;
return (new cljs.core.RecordIter((0),G__50998__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51000,other51001){
var self__ = this;
var this51000__$1 = this;
return (((!((other51001 == null)))) && ((((this51000__$1.constructor === other51001.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51000__$1.status,other51001.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51000__$1.body,other51001.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51000__$1.status_text,other51001.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51000__$1.headers,other51001.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51000__$1.was_aborted,other51001.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51000__$1.__extmap,other51001.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k50999){
var self__ = this;
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__50998){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__51079 = cljs.core.keyword_identical_QMARK_;
var expr__51080 = k__4470__auto__;
if(cljs.core.truth_((pred__51079.cljs$core$IFn$_invoke$arity$2 ? pred__51079.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__51080) : pred__51079.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__51080)))){
return (new ajax.protocols.Response(G__50998,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51079.cljs$core$IFn$_invoke$arity$2 ? pred__51079.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__51080) : pred__51079.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__51080)))){
return (new ajax.protocols.Response(self__.status,G__50998,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51079.cljs$core$IFn$_invoke$arity$2 ? pred__51079.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__51080) : pred__51079.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__51080)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__50998,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51079.cljs$core$IFn$_invoke$arity$2 ? pred__51079.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__51080) : pred__51079.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__51080)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__50998,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51079.cljs$core$IFn$_invoke$arity$2 ? pred__51079.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__51080) : pred__51079.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__51080)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__50998,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__50998),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__50998){
var self__ = this;
var this__4460__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__50998,self__.__extmap,self__.__hash));
}));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__51002),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__51002),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__51002),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__51002),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__51002),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
