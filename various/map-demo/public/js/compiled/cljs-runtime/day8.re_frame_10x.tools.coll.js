...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__42334_SHARP_,p2__42333_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__42333_SHARP_) : pred.call(null,p2__42333_SHARP_)))){
return p1__42334_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__42340_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__42340_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__42340_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__42343){
var vec__42344 = p__42343;
var seq__42345 = cljs.core.seq(vec__42344);
var first__42346 = cljs.core.first(seq__42345);
var seq__42345__$1 = cljs.core.next(seq__42345);
var k = first__42346;
var ks = seq__42345__$1;
var keys = vec__42344;
if(ks){
