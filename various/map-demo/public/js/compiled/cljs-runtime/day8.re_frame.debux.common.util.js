...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__55877){
var vec__55878 = p__55877;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55878,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55878,(1),null);
...
return clojure.zip.zipper((function (p1__55881_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__55881_SHARP_)) || (cljs.core.map_QMARK_(p1__55881_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__55883){
var vec__55884 = p__55883;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55884,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55884,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__55890_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__55890_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55889_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__55889_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__55891_SHARP_){
return (((p1__55891_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__55891_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__55902,mapping){
var map__55903 = p__55902;
var map__55903__$1 = cljs.core.__destructure_map(map__55903);
var state = map__55903__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55903__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55903__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55903__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__55900_SHARP_){
var and__4210__auto__ = (p1__55900_SHARP_ instanceof cljs.core.Symbol);
if(and__4210__auto__){
return cljs.core.namespace(p1__55900_SHARP_);
} else {
...
var G__55970 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__55971 = clojure.zip.next(loc);
loc = G__55971;
continue;
}
}
...
var len__4818__auto___55982 = arguments.length;
var i__4819__auto___55983 = (0);
while(true){
if((i__4819__auto___55983 < len__4818__auto___55982)){
args__4824__auto__.push((arguments[i__4819__auto___55983]));

var G__55984 = (i__4819__auto___55983 + (1));
i__4819__auto___55983 = G__55984;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__55921){
var vec__55922 = p__55921;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55922,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq55912){
var G__55913 = cljs.core.first(seq55912);
var seq55912__$1 = cljs.core.next(seq55912);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55913,seq55912__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__55927_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__55927_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__55939_55985 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__55940_55986 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__55941_55987 = true;
var _STAR_print_fn_STAR__temp_val__55942_55988 = (function (x__4750__auto__){
return sb__4749__auto__.append(x__4750__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__55941_55987);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__55942_55988);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__55940_55986);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__55939_55985);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4749__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__55932_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__55932_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__55991 = cljs.core.next(opts__$1);
var G__55992 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__55991;
acc = G__55992;
continue;
} else {
if(typeof f === 'string'){
var G__55993 = cljs.core.next(opts__$1);
var G__55994 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__55993;
acc = G__55994;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__55995 = cljs.core.nnext(opts__$1);
var G__55996 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__55995;
acc = G__55996;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__55998 = cljs.core.next(opts__$1);
var G__55999 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__55998;
acc = G__55999;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__55949 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__55949.cljs$core$IFn$_invoke$arity$1 ? fexpr__55949.cljs$core$IFn$_invoke$arity$1(f) : fexpr__55949.call(null,f));
})())){
var G__56002 = cljs.core.next(opts__$1);
var G__56003 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__56002;
acc = G__56003;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__55950 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__55950.cljs$core$IFn$_invoke$arity$1 ? fexpr__55950.cljs$core$IFn$_invoke$arity$1(f) : fexpr__55950.call(null,f));
})())){
var G__56005 = cljs.core.nnext(opts__$1);
var G__56006 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__56005;
acc = G__56006;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__56007 = cljs.core.next(opts__$1);
var G__56008 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__56007;
acc = G__56008;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__55952){
...
var G__55957 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__55956 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__55956.cljs$core$IFn$_invoke$arity$1 ? fexpr__55956.cljs$core$IFn$_invoke$arity$1(G__55957) : fexpr__55956.call(null,G__55957));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__55963 = quoted_form;
var G__55964 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__55963,G__55964) : day8.re_frame.debux.common.util.remove_d.call(null,G__55963,G__55964));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__55965 = quoted_form;
var G__55966 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__55965,G__55966) : day8.re_frame.debux.common.util.remove_d.call(null,G__55965,G__55966));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__56014__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__55967 = quoted_form;
var G__55968 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__55967,G__55968) : day8.re_frame.debux.common.util.remove_d.call(null,G__55967,G__55968));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__56014 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__56020__i = 0, G__56020__a = new Array(arguments.length -  0);
while (G__56020__i < G__56020__a.length) {G__56020__a[G__56020__i] = arguments[G__56020__i + 0]; ++G__56020__i;}
  arg = new cljs.core.IndexedSeq(G__56020__a,0,null);
} 
return G__56014__delegate.call(this,arg);};
G__56014.cljs$lang$maxFixedArity = 0;
G__56014.cljs$lang$applyTo = (function (arglist__56021){
var arg = cljs.core.seq(arglist__56021);
return G__56014__delegate(arg);
});
G__56014.cljs$core$IFn$_invoke$arity$variadic = G__56014__delegate;
return G__56014;
})()
;
});
...
var G__56030 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__56030;
continue;
} else {
...
var G__56033 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__56033;
continue;
} else {
var G__56037 = clojure.zip.next(loc);
loc = G__56037;
continue;
