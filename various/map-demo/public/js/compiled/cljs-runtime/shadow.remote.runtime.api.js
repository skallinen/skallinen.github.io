...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_48995 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_48995(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_48998 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_48998(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_48999 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_48999(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_49003 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_49003(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49008 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49008(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49009 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49009(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__48989,callback){
var map__48990 = p__48989;
var map__48990__$1 = cljs.core.__destructure_map(map__48990);
var input = map__48990__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48990__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48990__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
