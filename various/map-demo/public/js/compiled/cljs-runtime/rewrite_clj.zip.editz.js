...
var G__45467 = (function (){var G__45468 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__45468) : f.call(null,G__45468));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__45467) : rewrite_clj.node.coerce.call(null,G__45467));
});
/**
...
var len__4818__auto___45556 = arguments.length;
var i__4819__auto___45589 = (0);
while(true){
if((i__4819__auto___45589 < len__4818__auto___45556)){
args__4824__auto__.push((arguments[i__4819__auto___45589]));

var G__45673 = (i__4819__auto___45589 + (1));
i__4819__auto___45589 = G__45673;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__45469_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__45469_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq45471){
var G__45472 = cljs.core.first(seq45471);
var seq45471__$1 = cljs.core.next(seq45471);
var G__45473 = cljs.core.first(seq45471__$1);
var seq45471__$2 = cljs.core.next(seq45471__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45472,G__45473,seq45471__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__45521 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__45521) : str_fn.call(null,G__45521));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__45527 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__45527) : str_fn.call(null,G__45527));
})()):null)));
...
var G__45541 = rewrite_clj.zip.base.tag(zloc);
var G__45541__$1 = (((G__45541 instanceof cljs.core.Keyword))?G__45541.fqn:null);
switch (G__45541__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__45539_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__45539_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__45540_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__45540_SHARP_)].join('');
}));
}
}));
...
var G__45548 = rewrite_clj.zip.base.tag(zloc);
var G__45548__$1 = (((G__45548 instanceof cljs.core.Keyword))?G__45548.fqn:null);
switch (G__45548__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__45544_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__45544_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
