...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k44075,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k44075,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__44103){
var vec__44104 = p__44103;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44104,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44104,(1),null);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__44074){
var self__ = this;
var G__44074__$1 = this;
return (new cljs.core.RecordIter((0),G__44074__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this44076,other44077){
var self__ = this;
var this44076__$1 = this;
return (((!((other44077 == null)))) && ((((this44076__$1.constructor === other44077.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this44076__$1.children,other44077.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this44076__$1.__extmap,other44077.__extmap)))))));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k44075){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k44075);

}
}));

(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__44074){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__44150 = cljs.core.keyword_identical_QMARK_;
var expr__44151 = k__4470__auto__;
if(cljs.core.truth_((pred__44150.cljs$core$IFn$_invoke$arity$2 ? pred__44150.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__44151) : pred__44150.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__44151)))){
return (new rewrite_clj.node.forms.FormsNode(G__44074,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__44074),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__44074){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__44074,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__44082){
var extmap__4501__auto__ = (function (){var G__44165 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__44082,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__44082)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__44165);
} else {
return G__44165;
}
})();
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__44082),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
