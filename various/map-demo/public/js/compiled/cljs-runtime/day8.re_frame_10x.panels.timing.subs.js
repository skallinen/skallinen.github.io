...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46091_SHARP_){
return ((day8.re_frame_10x.tools.metamorphic.request_animation_frame_QMARK_(p1__46091_SHARP_)) || (day8.re_frame_10x.tools.metamorphic.request_animation_frame_end_QMARK_(p1__46091_SHARP_)));
}),traces);
})], 0));
...
var len__4818__auto___46135 = arguments.length;
var i__4819__auto___46136 = (0);
while(true){
if((i__4819__auto___46136 < len__4818__auto___46135)){
args_arr__4839__auto__.push((arguments[i__4819__auto___46136]));

var G__46137 = (i__4819__auto___46136 + (1));
i__4819__auto___46136 = G__46137;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$applyTo = (function (seq46095){
var G__46096 = cljs.core.first(seq46095);
var seq46095__$1 = cljs.core.next(seq46095);
var G__46097 = cljs.core.first(seq46095__$1);
var seq46095__$2 = cljs.core.next(seq46095__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46096,G__46097,seq46095__$2);
}));

(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$maxFixedArity = (2));

day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-time","day8.re-frame-10x.panels.timing.subs/animation-frame-time",1191520772),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-traces","day8.re-frame-10x.panels.timing.subs/animation-frame-traces",-1778771106)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.traces.subs","filtered-by-epoch-always","day8.re-frame-10x.panels.traces.subs/filtered-by-epoch-always",-1807060768)], null),(function (p__46107,p__46108){
var vec__46109 = p__46107;
var af_start_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46109,(0),null);
var epoch_traces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46109,(1),null);
var vec__46112 = p__46108;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46112,(0),null);
var frame_number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46112,(1),null);
...
var vec__46115 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(frame_pairs,(frame_number - (1)));
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46115,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46115,(1),null);
...
var map__46130 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
var map__46130__$1 = cljs.core.__destructure_map(map__46130);
var event_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46130__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46130__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46130__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46130__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
