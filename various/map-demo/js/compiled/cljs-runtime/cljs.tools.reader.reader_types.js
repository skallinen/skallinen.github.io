...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40340 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40340(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40341 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40341(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40343 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40343(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40344 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40344(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40346 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40346(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40349 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40349(reader);
}
});
...
var G__40386 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40387 = s.append(c);
c = G__40386;
s = G__40387;
continue;
}
