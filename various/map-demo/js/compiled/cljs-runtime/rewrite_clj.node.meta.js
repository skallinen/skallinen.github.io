...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k44600,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k44600,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__44628){
var vec__44630 = p__44628;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44630,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44630,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this44601,other44602){
var self__ = this;
var this44601__$1 = this;
return (((!((other44602 == null)))) && ((((this44601__$1.constructor === other44602.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this44601__$1.tag,other44602.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this44601__$1.prefix,other44602.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this44601__$1.children,other44602.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this44601__$1.__extmap,other44602.__extmap)))))))))));
}));
...
var self__ = this;
var ___$1 = this;
var vec__44701 = rewrite_clj.node.protocols.sexprs(self__.children);
var mta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44701,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44701,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k44600){
var self__ = this;
var this__4468__auto____$1 = this;
var G__44725 = k44600;
var G__44725__$1 = (((G__44725 instanceof cljs.core.Keyword))?G__44725.fqn:null);
switch (G__44725__$1) {
case "tag":
case "prefix":
case "children":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k44600);

}
}));

(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__44599){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__44728 = cljs.core.keyword_identical_QMARK_;
var expr__44729 = k__4470__auto__;
if(cljs.core.truth_((pred__44728.cljs$core$IFn$_invoke$arity$2 ? pred__44728.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__44729) : pred__44728.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__44729)))){
return (new rewrite_clj.node.meta.MetaNode(G__44599,self__.prefix,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__44728.cljs$core$IFn$_invoke$arity$2 ? pred__44728.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__44729) : pred__44728.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__44729)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,G__44599,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__44728.cljs$core$IFn$_invoke$arity$2 ? pred__44728.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__44729) : pred__44728.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__44729)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,G__44599,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__44599),null));
}
}
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__44599){
var self__ = this;
var this__4460__auto____$1 = this;
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,G__44599,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.meta.map__GT_MetaNode = (function rewrite_clj$node$meta$map__GT_MetaNode(G__44604){
var extmap__4501__auto__ = (function (){var G__44750 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__44604,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__44604)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__44750);
} else {
return G__44750;
}
})();
return (new rewrite_clj.node.meta.MetaNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__44604),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__44604),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__44604),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
