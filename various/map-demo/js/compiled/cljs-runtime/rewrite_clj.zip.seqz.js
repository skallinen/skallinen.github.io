...
var G__45741 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__45741__$1 = (((G__45741 == null))?null:cljs.core.iterate((function (loc){
...
var G__45741__$2 = (((G__45741__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__45741__$1));
var G__45741__$3 = (((G__45741__$2 == null))?null:cljs.core.last(G__45741__$2));
if((G__45741__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__45741__$3);
}
} else {
return zloc;
}
...
var G__45802 = rewrite_clj.zip.move.right(v);
var G__45803 = rewrite_clj.zip.move.up(v);
loc = G__45802;
parent = G__45803;
continue;
} else {
var G__45804 = rewrite_clj.zip.move.right(v0);
var G__45805 = parent;
loc = G__45804;
parent = G__45805;
continue;
...
var G__45807 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__45808 = rewrite_clj.zip.move.up(v);
loc = G__45807;
parent = G__45808;
continue;
} else {
var G__45809 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__45810 = parent;
loc = G__45809;
parent = G__45810;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__45763 = zloc;
var G__45763__$1 = (((G__45763 == null))?null:rewrite_clj.zip.move.down(G__45763));
var G__45763__$2 = (((G__45763__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__45763__$1,k));
if((G__45763__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__45763__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__45768 = rewrite_clj.zip.move.down(zloc);
var G__45768__$1 = (((G__45768 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__45768));
if((G__45768__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__45768__$1);
}
})(),k);
}
});
