...
return [(function (){var pred__42004 = cljs.core.instance_QMARK_;
var expr__42005 = reactive_val;
if(cljs.core.truth_((pred__42004.cljs$core$IFn$_invoke$arity$2 ? pred__42004.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__42005) : pred__42004.call(null,reagent.ratom.RAtom,expr__42005)))){
return "ra";
} else {
if(cljs.core.truth_((pred__42004.cljs$core$IFn$_invoke$arity$2 ? pred__42004.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__42005) : pred__42004.call(null,reagent.ratom.RCursor,expr__42005)))){
return "rc";
} else {
if(cljs.core.truth_((pred__42004.cljs$core$IFn$_invoke$arity$2 ? pred__42004.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__42005) : pred__42004.call(null,reagent.ratom.Reaction,expr__42005)))){
return "rx";
} else {
if(cljs.core.truth_((pred__42004.cljs$core$IFn$_invoke$arity$2 ? pred__42004.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__42005) : pred__42004.call(null,reagent.ratom.Track,expr__42005)))){
return "tr";
} else {
return "other";
}
