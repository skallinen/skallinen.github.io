...
var G__45095 = clojure.zip.node(loc);
var fexpr__45094 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__45094.cljs$core$IFn$_invoke$arity$1 ? fexpr__45094.cljs$core$IFn$_invoke$arity$1(G__45095) : fexpr__45094.call(null,G__45095));
});
/**
...
var G__45099 = clojure.zip.node(loc);
var fexpr__45098 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var fexpr__45102 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__45102.cljs$core$IFn$_invoke$arity$2 ? fexpr__45102.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__45102.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__45108 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45108,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45108,(1),null);
var vec__45111 = clojure.zip.children(loc);
...
var vec__45114 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45114,(0),null);
var map__45117 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45114,(1),null);
var map__45117__$1 = cljs.core.__destructure_map(map__45117);
var path = map__45117__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45117__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45117__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45117__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45117__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45117__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__45150 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45150,(0),null);
var map__45153 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45150,(1),null);
var map__45153__$1 = cljs.core.__destructure_map(map__45153);
var path = map__45153__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45153__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__45154 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45153__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__45155 = cljs.core.seq(vec__45154);
var first__45156 = cljs.core.first(seq__45155);
var seq__45155__$1 = cljs.core.next(seq__45155);
var r = first__45156;
var rnext = seq__45155__$1;
var rs = vec__45154;
...
var vec__45160 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45160,(0),null);
var map__45163 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45160,(1),null);
var map__45163__$1 = cljs.core.__destructure_map(map__45163);
var path = map__45163__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45163__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45163__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
return r;
} else {
...
var vec__45171 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45171,(0),null);
var map__45174 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45171,(1),null);
var map__45174__$1 = cljs.core.__destructure_map(map__45174);
var path = map__45174__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45174__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45174__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
...
var vec__45175 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45175,(0),null);
var map__45178 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45175,(1),null);
var map__45178__$1 = cljs.core.__destructure_map(map__45178);
var path = map__45178__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45178__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45178__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4210__auto__ = path;
if(cljs.core.truth_(and__4210__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__45186 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45186,(0),null);
var map__45189 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45186,(1),null);
var map__45189__$1 = cljs.core.__destructure_map(map__45189);
var path = map__45189__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45189__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__45191 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45191,(0),null);
var map__45194 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45191,(1),null);
var map__45194__$1 = cljs.core.__destructure_map(map__45194);
var path = map__45194__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45194__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__45196 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45196,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45196,(1),null);
...
var len__4818__auto___45316 = arguments.length;
var i__4819__auto___45317 = (0);
while(true){
if((i__4819__auto___45317 < len__4818__auto___45316)){
args__4824__auto__.push((arguments[i__4819__auto___45317]));

var G__45318 = (i__4819__auto___45317 + (1));
i__4819__auto___45317 = G__45318;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq45202){
var G__45203 = cljs.core.first(seq45202);
var seq45202__$1 = cljs.core.next(seq45202);
var G__45204 = cljs.core.first(seq45202__$1);
var seq45202__$2 = cljs.core.next(seq45202__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45203,G__45204,seq45202__$2);
}));
...
var G__45330 = clojure.zip.rightmost(child);
loc__$1 = G__45330;
continue;
} else {
return loc__$1;
...
var vec__45239 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45239,(0),null);
var map__45242 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45239,(1),null);
var map__45242__$1 = cljs.core.__destructure_map(map__45242);
var path = map__45242__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45242__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45242__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45242__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45242__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__45336 = clojure.zip.rightmost(child);
loc__$1 = G__45336;
continue;
} else {
return loc__$1;
