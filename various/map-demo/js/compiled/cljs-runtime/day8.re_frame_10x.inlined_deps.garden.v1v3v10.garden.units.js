 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__41303,right){
var map__41304 = p__41303;
var map__41304__$1 = cljs.core.__destructure_map(map__41304);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41304__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41304__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__41307 = temp__5753__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41307,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41307,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41307,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41315__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__41316 = u(y);
var map__41316__$1 = cljs.core.__destructure_map(map__41316);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41316__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__41341__delegate = function (x,y,more){
...
var G__41341 = function (x,y,var_args){
var more = null;
...
while (G__41342__i < G__41342__a.length) {G__41342__a[G__41342__i] = arguments[G__41342__i + 2]; ++G__41342__i;}
  more = new cljs.core.IndexedSeq(G__41342__a,0,null);
} 
return G__41341__delegate.call(this,x,y,more);};
G__41341.cljs$lang$maxFixedArity = 2;
G__41341.cljs$lang$applyTo = (function (arglist__41343){
var x = cljs.core.first(arglist__41343);
arglist__41343 = cljs.core.next(arglist__41343);
var y = cljs.core.first(arglist__41343);
var more = cljs.core.rest(arglist__41343);
return G__41341__delegate(x,y,more);
});
...
var G__41344 = null;
if (arguments.length > 2) {
var G__41345__i = 0, G__41345__a = new Array(arguments.length -  2);
while (G__41345__i < G__41345__a.length) {G__41345__a[G__41345__i] = arguments[G__41345__i + 2]; ++G__41345__i;}
G__41344 = new cljs.core.IndexedSeq(G__41345__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__41344);
}
...
var map__41317 = u(x);
var map__41317__$1 = cljs.core.__destructure_map(map__41317);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41317__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__41318 = u(y);
var map__41318__$1 = cljs.core.__destructure_map(map__41318);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41318__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__41350__delegate = function (x,y,more){
...
var G__41350 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__41351__i = 0, G__41351__a = new Array(arguments.length -  2);
while (G__41351__i < G__41351__a.length) {G__41351__a[G__41351__i] = arguments[G__41351__i + 2]; ++G__41351__i;}
  more = new cljs.core.IndexedSeq(G__41351__a,0,null);
} 
return G__41350__delegate.call(this,x,y,more);};
G__41350.cljs$lang$maxFixedArity = 2;
G__41350.cljs$lang$applyTo = (function (arglist__41352){
var x = cljs.core.first(arglist__41352);
arglist__41352 = cljs.core.next(arglist__41352);
var y = cljs.core.first(arglist__41352);
var more = cljs.core.rest(arglist__41352);
return G__41350__delegate(x,y,more);
});
...
var G__41353 = null;
if (arguments.length > 2) {
var G__41354__i = 0, G__41354__a = new Array(arguments.length -  2);
while (G__41354__i < G__41354__a.length) {G__41354__a[G__41354__i] = arguments[G__41354__i + 2]; ++G__41354__i;}
G__41353 = new cljs.core.IndexedSeq(G__41354__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__41353);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41319__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__41320 = u(y);
var map__41320__$1 = cljs.core.__destructure_map(map__41320);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41320__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__41357__delegate = function (x,y,more){
...
var G__41357 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__41358__i = 0, G__41358__a = new Array(arguments.length -  2);
while (G__41358__i < G__41358__a.length) {G__41358__a[G__41358__i] = arguments[G__41358__i + 2]; ++G__41358__i;}
  more = new cljs.core.IndexedSeq(G__41358__a,0,null);
} 
return G__41357__delegate.call(this,x,y,more);};
G__41357.cljs$lang$maxFixedArity = 2;
G__41357.cljs$lang$applyTo = (function (arglist__41359){
var x = cljs.core.first(arglist__41359);
arglist__41359 = cljs.core.next(arglist__41359);
var y = cljs.core.first(arglist__41359);
var more = cljs.core.rest(arglist__41359);
return G__41357__delegate(x,y,more);
});
G__41357.cljs$core$IFn$_invoke$arity$variadic = G__41357__delegate;
return G__41357;
})()
;
...
var G__41360 = null;
if (arguments.length > 2) {
var G__41361__i = 0, G__41361__a = new Array(arguments.length -  2);
while (G__41361__i < G__41361__a.length) {G__41361__a[G__41361__i] = arguments[G__41361__i + 2]; ++G__41361__i;}
G__41360 = new cljs.core.IndexedSeq(G__41361__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__41360);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41321__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__41322 = u(y);
var map__41322__$1 = cljs.core.__destructure_map(map__41322);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41322__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__41366__delegate = function (x,y,more){
...
var G__41366 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__41368__i = 0, G__41368__a = new Array(arguments.length -  2);
while (G__41368__i < G__41368__a.length) {G__41368__a[G__41368__i] = arguments[G__41368__i + 2]; ++G__41368__i;}
  more = new cljs.core.IndexedSeq(G__41368__a,0,null);
} 
return G__41366__delegate.call(this,x,y,more);};
G__41366.cljs$lang$maxFixedArity = 2;
G__41366.cljs$lang$applyTo = (function (arglist__41369){
var x = cljs.core.first(arglist__41369);
arglist__41369 = cljs.core.next(arglist__41369);
var y = cljs.core.first(arglist__41369);
var more = cljs.core.rest(arglist__41369);
return G__41366__delegate(x,y,more);
});
...
var G__41371 = null;
if (arguments.length > 2) {
var G__41372__i = 0, G__41372__a = new Array(arguments.length -  2);
while (G__41372__i < G__41372__a.length) {G__41372__a[G__41372__i] = arguments[G__41372__i + 2]; ++G__41372__i;}
G__41371 = new cljs.core.IndexedSeq(G__41372__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__41371);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
