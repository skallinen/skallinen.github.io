...
var G__41299 = o;
goog.object.set(G__41299,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__41334__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__41334 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__41335__i = 0, G__41335__a = new Array(arguments.length -  0);
while (G__41335__i < G__41335__a.length) {G__41335__a[G__41335__i] = arguments[G__41335__i + 0]; ++G__41335__i;}
  args = new cljs.core.IndexedSeq(G__41335__a,0,null);
} 
return G__41334__delegate.call(this,args);};
G__41334.cljs$lang$maxFixedArity = 0;
G__41334.cljs$lang$applyTo = (function (arglist__41336){
var args = cljs.core.seq(arglist__41336);
return G__41334__delegate(args);
});
G__41334.cljs$core$IFn$_invoke$arity$variadic = G__41334__delegate;
return G__41334;
})()
;
} else {
...
var G__41305 = o;
goog.object.set(G__41305,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__41306 = props;
var G__41306__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41306,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41306);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41306__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__41310 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41310,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__41310;
}
})(),id_class);
...
var G__41311 = (cljs.core.count(argv) - first_child);
switch (G__41311) {
case (0):
...
var vec__41312 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41312,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41312,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41312,(2),null);
...
var temp__5757__auto___41346 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___41346 == null)){
} else {
var key_41347 = temp__5757__auto___41346;
(jsprops.key = key_41347);
}
...
var temp__5757__auto___41348 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___41348 == null)){
} else {
var key_41349 = temp__5757__auto___41348;
(jsprops.key = key_41349);
}
...
var temp__5757__auto___41355 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___41355 == null)){
} else {
var key_41356 = temp__5757__auto___41355;
(jsprops.key = key_41356);
}
...
var temp__5757__auto___41374 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___41374 == null)){
} else {
var key_41376 = temp__5757__auto___41374;
(jsprops.key = key_41376);
}
...
var temp__5757__auto___41377 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___41377 == null)){
} else {
var key_41378 = temp__5757__auto___41377;
(jsprops.key = key_41378);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41324_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__41324_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__41325 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41325,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41325,(1),null);
...
break;
default:
var G__41388 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__41389 = compiler;
v = G__41388;
compiler = G__41389;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template41331 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template41331 = (function (opts,id,fn_to_element,parse_fn,meta41332){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template41331.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41333,meta41332__$1){
var self__ = this;
var _41333__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template41331(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta41332__$1));
}));

(reagent.impl.template.t_reagent$impl$template41331.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41333){
var self__ = this;
var _41333__$1 = this;
return self__.meta41332;
}));

(reagent.impl.template.t_reagent$impl$template41331.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template41331.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template41331.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template41331.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template41331.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template41331.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta41332","meta41332",1605069079,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template41331.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template41331.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template41331");

(reagent.impl.template.t_reagent$impl$template41331.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template41331");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template41331.
 */
reagent.impl.template.__GT_t_reagent$impl$template41331 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template41331(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta41332){
return (new reagent.impl.template.t_reagent$impl$template41331(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta41332));
});

}

return (new reagent.impl.template.t_reagent$impl$template41331(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
