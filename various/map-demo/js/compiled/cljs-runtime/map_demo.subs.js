...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34632_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__34632_SHARP_,k),v);
}),m);
});
/**
 * Handler for filtering jobs according to user input
 */
map_demo.subs.markers_filter_handler = (function map_demo$subs$markers_filter_handler(p__34636){
var vec__34644 = p__34636;
var markers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34644,(0),null);
var only_ta_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34644,(1),null);
var only_traffic_effect_3_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34644,(2),null);
return (function (p1__34635_SHARP_){
if(cljs.core.truth_(only_ta_QMARK_)){
return map_demo.subs.filter_kv(p1__34635_SHARP_,new cljs.core.Keyword(null,"type","type",1174270348),"ta");
} else {
return p1__34635_SHARP_;
}
})((function (p1__34633_SHARP_){
if(cljs.core.truth_(only_traffic_effect_3_QMARK_)){
return map_demo.subs.filter_kv(p1__34633_SHARP_,new cljs.core.Keyword(null,"estimated-traffic-effect","estimated-traffic-effect",277892274),"3");
} else {
...
}),map_demo.subs.markers_filter_handler], 0));
