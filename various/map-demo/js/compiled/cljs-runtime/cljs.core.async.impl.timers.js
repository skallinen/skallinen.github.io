...
var i_48955 = (0);
while(true){
if((i_48955 < arr.length)){
(arr[i_48955] = null);

var G__48956 = (i_48955 + (1));
i_48955 = G__48956;
continue;
} else {
}
...
var i_48966 = (self__.level + (1));
while(true){
if((i_48966 <= (new_level + (1)))){
(update[i_48966] = self__.header);

var G__48967 = (i_48966 + (1));
i_48966 = G__48967;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_48968 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_48968[i]));
} else {
x__$2.forward.push((((i < links_48968.length))?(links_48968[i]):null));
}

if((i < links_48968.length)){
(links_48968[i] = x__$2);
} else {
links_48968.push(x__$2);
}
...
var i_48971 = (0);
while(true){
if((i_48971 <= self__.level)){
var links_48972 = (update[i_48971]).forward;
if((x__$1 === (((i_48971 < links_48972.length))?(links_48972[i_48971]):null))){
(links_48972[i_48971] = (x__$1.forward[i_48971]));

var G__48974 = (i_48971 + (1));
i_48971 = G__48974;
continue;
} else {
var G__48975 = (i_48971 + (1));
i_48971 = G__48975;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__48985 = nx;
var G__48986 = (level__$1 - (1));
x = G__48985;
level__$1 = G__48986;
continue;
} else {
var G__48987 = x;
var G__48988 = (level__$1 - (1));
x = G__48987;
level__$1 = G__48988;
continue;
}
