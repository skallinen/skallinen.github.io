...
if((c === "\n")){
var G__45227 = escape_QMARK_;
var G__45228 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__45227;
lines = G__45228;
continue;
} else {
buf.append(c);

var G__45230 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__45231 = lines;
escape_QMARK_ = G__45230;
lines = G__45231;
continue;
...
var G__45220 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__45220) : rewrite_clj.node.string_node.call(null,G__45220));
});
...
var G__45221 = cljs.core.re_pattern(regex);
var G__45222 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__45221,G__45222) : rewrite_clj.node.token_node.call(null,G__45221,G__45222));
});
