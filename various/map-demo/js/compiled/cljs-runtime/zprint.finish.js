...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__43952_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43952_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__43952_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__43955){
var vec__43957 = p__43955;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43957,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43957,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__43961,s,color,element,idx){
var map__43963 = p__43961;
var map__43963__$1 = cljs.core.__destructure_map(map__43963);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43963__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43963__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43963__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__43966 = (function (){var or__4212__auto__ = color;
...
var fexpr__43965 = (function (){var G__43967 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__43967) : style_map.call(null,G__43967));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__43970){
var vec__43971 = p__43970;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43971,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43971,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43971,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__43976){
var vec__43977 = p__43976;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43977,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43977,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43977,(2),null);
...
var G__44130 = cljs.core.next(ssv);
var G__44131 = (this_ssv == null);
var G__44132 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__44133 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__44130;
doing_nil_QMARK_ = G__44131;
last_elide = G__44132;
out = G__44133;
continue;
}
...
var vec__44006 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44006,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44006,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44006,(2),null);
...
var G__44135 = cljs.core.next(remaining_cvec);
var G__44136 = new_idx;
var G__44137 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__44135;
idx = G__44136;
out = G__44137;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__44023,cursor_vec){
var vec__44025 = p__44023;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44025,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44025,(1),null);
var focus_vec = vec__44025;
...
var vec__44028 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44028,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44028,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__44035){
var vec__44036 = p__44035;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44036,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44036,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__44045,existing_count){
var vec__44046 = p__44045;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44046,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44046,(1),null);
...
return cljs.core.filterv((function (p1__44042_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__44042_SHARP_))));
...
var vec__44065 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44065,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44065,(1),null);
var cvec_element = vec__44065;
if((cvec_element == null)){
var G__44166 = cljs.core.next(cvec_nl);
var G__44167 = (idx + (1));
var G__44168 = start;
var G__44169 = out;
cvec_nl = G__44166;
...
var G__44171 = cljs.core.next(cvec_nl);
var G__44172 = (idx + (1));
var G__44173 = idx;
var G__44174 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__44171;
idx = G__44172;
start = G__44173;
out = G__44174;
...
var G__44178 = cljs.core.next(cvec_nl);
var G__44179 = (idx + (1));
var G__44180 = (idx + (1));
var G__44181 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__44178;
idx = G__44179;
start = G__44180;
out = G__44181;
...
var G__44183 = cljs.core.next(cvec_nl);
var G__44184 = (idx + (1));
var G__44185 = idx;
...
var G__44187 = cljs.core.next(cvec_nl);
var G__44188 = (idx + (1));
var G__44189 = start;
var G__44190 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__44187;
idx = G__44188;
start = G__44189;
out = G__44190;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__44084_SHARP_,p2__44083_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__44083_SHARP_)){
return cljs.core.reduced(p1__44084_SHARP_);
} else {
return (p1__44084_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__44089,p__44090){
var vec__44091 = p__44089;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44091,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44091,(1),null);
var vec__44094 = p__44090;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44094,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44094,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__44114,cvec,focus_vec){
var map__44116 = p__44114;
var map__44116__$1 = cljs.core.__destructure_map(map__44116);
var options = map__44116__$1;
var map__44117 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44116__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__44117__$1 = cljs.core.__destructure_map(map__44117);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44117__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44117__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44117__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44109_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__44109_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
