...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__52176){
var map__52177 = p__52176;
var map__52177__$1 = cljs.core.__destructure_map(map__52177);
var request = map__52177__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52177__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__52195 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__52195.cljs$core$IFn$_invoke$arity$1 ? fexpr__52195.cljs$core$IFn$_invoke$arity$1(response) : fexpr__52195.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__52203 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__52203.cljs$core$IFn$_invoke$arity$1 ? fexpr__52203.cljs$core$IFn$_invoke$arity$1(response) : fexpr__52203.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__52211){
var map__52213 = p__52211;
var map__52213__$1 = cljs.core.__destructure_map(map__52213);
var request = map__52213__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52213__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
