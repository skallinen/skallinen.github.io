...
var G__24431 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24431;
continue;
} else {
return ch;
...
var vec__24432 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__24432,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq24435){
...
return (function() { 
var G__24440__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__24440 = function (rdr,var_args){
var _ = null;
...
while (G__24441__i < G__24441__a.length) {G__24441__a[G__24441__i] = arguments[G__24441__i + 1]; ++G__24441__i;}
  _ = new cljs.core.IndexedSeq(G__24441__a,0,null);
} 
return G__24440__delegate.call(this,rdr,_);};
G__24440.cljs$lang$maxFixedArity = 1;
G__24440.cljs$lang$applyTo = (function (arglist__24442){
var rdr = cljs.core.first(arglist__24442);
var _ = cljs.core.rest(arglist__24442);
return G__24440__delegate(rdr,_);
});
