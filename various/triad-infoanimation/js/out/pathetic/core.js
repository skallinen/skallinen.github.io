...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__28362_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__28362_SHARP_),cljs.core.second.call(null,p1__28362_SHARP_));
}),cljs.core.map.call(null,(function (p1__28363_SHARP_,p2__28364_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__28363_SHARP_,p2__28364_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__28365 = cljs.core.first.call(null,path_pieces);
switch (G__28365) {
case "":
...
var G__28367 = cljs.core.first.call(null,path_pieces);
...
var G__28369 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__28369)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__28369)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__28369)){
return path_pieces;
} else {
...
var curr = first__28378;
var remainder = seq__28377__$1;
var pred__28379 = cljs.core._EQ_;
var expr__28380 = curr;
if(cljs.core.truth_(pred__28379.call(null,null,expr__28380))){
return result;
} else {
if(cljs.core.truth_(pred__28379.call(null,"",expr__28380))){
var G__28382 = result;
var G__28383 = remainder;
result = G__28382;
remaining_path = G__28383;
continue;
} else {
if(cljs.core.truth_(pred__28379.call(null,".",expr__28380))){
var G__28384 = result;
var G__28385 = remainder;
result = G__28384;
remaining_path = G__28385;
continue;
} else {
if(cljs.core.truth_(pred__28379.call(null,"..",expr__28380))){
var G__28386 = pathetic.core.up_dir.call(null,result);
var G__28387 = remainder;
result = G__28386;
remaining_path = G__28387;
continue;
} else {
var G__28388 = cljs.core.conj.call(null,result,curr);
var G__28389 = remainder;
result = G__28388;
remaining_path = G__28389;
continue;
}
}
}
...
var pred__28393 = cljs.core._EQ_;
var expr__28394 = curr;
if(cljs.core.truth_(pred__28393.call(null,null,expr__28394))){
return suffix;
} else {
if(cljs.core.truth_(pred__28393.call(null,"",expr__28394))){
var G__28396 = suffix;
var G__28397 = cljs.core.rest.call(null,remainder);
suffix = G__28396;
remainder = G__28397;
continue;
} else {
if(cljs.core.truth_(pred__28393.call(null,".",expr__28394))){
var G__28398 = suffix;
var G__28399 = cljs.core.rest.call(null,remainder);
suffix = G__28398;
remainder = G__28399;
continue;
} else {
if(cljs.core.truth_(pred__28393.call(null,"..",expr__28394))){
var G__28400 = cljs.core.conj.call(null,suffix,"..");
var G__28401 = cljs.core.rest.call(null,remainder);
suffix = G__28400;
remainder = G__28401;
continue;
} else {
var G__28402 = cljs.core.conj.call(null,suffix,curr);
var G__28403 = cljs.core.rest.call(null,remainder);
suffix = G__28402;
remainder = G__28403;
continue;
}
...
var vec__28404 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__28404,(0),null);
var path = cljs.core.nth.call(null,vec__28404,(1),null);
var post_path = cljs.core.nth.call(null,vec__28404,(2),null);
...
var vec__28407 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__28407,(0),null);
var path = cljs.core.nth.call(null,vec__28407,(1),null);
var post_path = cljs.core.nth.call(null,vec__28407,(2),null);
