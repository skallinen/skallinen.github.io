...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__28723_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__28723_SHARP_),cljs.core.second.call(null,p1__28723_SHARP_));
}),cljs.core.map.call(null,(function (p1__28724_SHARP_,p2__28725_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__28724_SHARP_,p2__28725_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__28726 = cljs.core.first.call(null,path_pieces);
switch (G__28726) {
case "":
...
var G__28728 = cljs.core.first.call(null,path_pieces);
...
var G__28730 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__28730)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__28730)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__28730)){
return path_pieces;
} else {
...
var curr = first__28739;
var remainder = seq__28738__$1;
var pred__28740 = cljs.core._EQ_;
var expr__28741 = curr;
if(cljs.core.truth_(pred__28740.call(null,null,expr__28741))){
return result;
} else {
if(cljs.core.truth_(pred__28740.call(null,"",expr__28741))){
var G__28743 = result;
var G__28744 = remainder;
result = G__28743;
remaining_path = G__28744;
continue;
} else {
if(cljs.core.truth_(pred__28740.call(null,".",expr__28741))){
var G__28745 = result;
...
result = G__28745;
remaining_path = G__28746;
continue;
} else {
if(cljs.core.truth_(pred__28740.call(null,"..",expr__28741))){
var G__28747 = pathetic.core.up_dir.call(null,result);
var G__28748 = remainder;
result = G__28747;
remaining_path = G__28748;
continue;
} else {
var G__28749 = cljs.core.conj.call(null,result,curr);
var G__28750 = remainder;
result = G__28749;
remaining_path = G__28750;
continue;
}
}
}
...
var expr__28755 = curr;
if(cljs.core.truth_(pred__28754.call(null,null,expr__28755))){
return suffix;
} else {
if(cljs.core.truth_(pred__28754.call(null,"",expr__28755))){
var G__28757 = suffix;
var G__28758 = cljs.core.rest.call(null,remainder);
suffix = G__28757;
remainder = G__28758;
continue;
} else {
if(cljs.core.truth_(pred__28754.call(null,".",expr__28755))){
var G__28759 = suffix;
var G__28760 = cljs.core.rest.call(null,remainder);
suffix = G__28759;
remainder = G__28760;
continue;
} else {
if(cljs.core.truth_(pred__28754.call(null,"..",expr__28755))){
var G__28761 = cljs.core.conj.call(null,suffix,"..");
var G__28762 = cljs.core.rest.call(null,remainder);
suffix = G__28761;
remainder = G__28762;
continue;
} else {
var G__28763 = cljs.core.conj.call(null,suffix,curr);
var G__28764 = cljs.core.rest.call(null,remainder);
suffix = G__28763;
remainder = G__28764;
continue;
}
...
var vec__28765 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__28765,(0),null);
var path = cljs.core.nth.call(null,vec__28765,(1),null);
var post_path = cljs.core.nth.call(null,vec__28765,(2),null);
...
var vec__28768 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__28768,(0),null);
var path = cljs.core.nth.call(null,vec__28768,(1),null);
var post_path = cljs.core.nth.call(null,vec__28768,(2),null);
...
//# sourceMappingURL=core.js.map?rel=1587041651772
