...
var o24024 = temp__5733__auto__;
var temp__5733__auto____$1 = (o24024["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o24025 = temp__5733__auto____$1;
return (o24025["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23785__auto__ = f;
return (o__23785__auto__["toString"]).call(o__23785__auto__);
} else {
return "";
}
}catch (e24026){var _ = e24026;
return "";
}});
...
try{var o__23785__auto___24028 = t;
(o__23785__auto___24028["cljs$lang$ctorPrWriter"]).call(o__23785__auto___24028,t,writer);
}catch (e24027){var __24029 = e24027;
}
...
var char_code = (function (){var o__23785__auto__ = (new String(char$));
return (o__23785__auto__["charCodeAt"]).call(o__23785__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23785__auto__ = String;
return (o__23785__auto__["fromCharCode"]).call(o__23785__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24030 = num_code;
switch (G__24030) {
case (1):
return (185);
...
var o__23785__auto__ = String;
return (o__23785__auto__["fromCharCode"]).call(o__23785__auto__,superscript_code);
});
/**
...
}catch (e24032){var _e__23792__auto__ = e24032;
return false;
}})())){
...
var vec__24033 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24033,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o24036 = temp__5733__auto__;
var temp__5733__auto____$1 = (o24036["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o24037 = temp__5733__auto____$1;
return (o24037["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4789__auto___24044 = arguments.length;
var i__4790__auto___24045 = (0);
while(true){
if((i__4790__auto___24045 < len__4789__auto___24044)){
args__4795__auto__.push((arguments[i__4790__auto___24045]));

var G__24046 = (i__4790__auto___24045 + (1));
i__4790__auto___24045 = G__24046;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24040){
var vec__24041 = p__24040;
var ns_detector = cljs.core.nth.call(null,vec__24041,(0),null);
...
var G__24047 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24048 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24047;
remaining_tokens = G__24048;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24038){
var G__24039 = cljs.core.first.call(null,seq24038);
var seq24038__$1 = cljs.core.next.call(null,seq24038);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24039,seq24038__$1);
}));
...
var vec__24052 = cljs.core.split_with.call(null,(function (p1__24051_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24051_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24052,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24052,(1),null);
...
var vec__24058 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24058,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24058,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24061 = cljs.core.rest.call(null,remaining_tokens);
var G__24062 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24061;
name_tokens = G__24062;
continue;
} else {
...
var vec__24065 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24065,(0),null);
var arity = cljs.core.nth.call(null,vec__24065,(1),null);
var vec__24068 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24068,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24068,(1),null);
var vec__24071 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24071,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24071,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24071,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24071,(3),null);
...
var vec__24077 = result;
var munged_ns = cljs.core.nth.call(null,vec__24077,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24077,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24077,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24077,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24077,(4),null);
var arity = cljs.core.nth.call(null,vec__24077,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__24081 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__24081,(0),null);
var args = cljs.core.nth.call(null,vec__24081,(1),null);
var vec__24084 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24084,(0),null);
var name = cljs.core.nth.call(null,vec__24084,(1),null);
...
var G__24087 = (arity + (1));
var G__24088 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24089){
var vec__24090 = p__24089;
var arity = cljs.core.nth.call(null,vec__24090,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24090,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24093_SHARP_){
return cljs.core.get.call(null,arities,p1__24093_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__24094_SHARP_){
return cljs.core.drop.call(null,(2),p1__24094_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24097){
var vec__24098 = p__24097;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24098,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24095){
var G__24096 = cljs.core.first.call(null,seq24095);
var seq24095__$1 = cljs.core.next.call(null,seq24095);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24096,seq24095__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24106__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24106__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24106__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24106__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24107 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24107,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24107,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24107,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24107,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24107,(4),null);
var arity = cljs.core.nth.call(null,vec__24107,(5),null);
...
var o__23785__auto__ = f;
return (o__23785__auto__["getBasis"]).call(o__23785__auto__);
});
/**
...
}catch (e24111){var _e__23792__auto__ = e24111;
...
var G__24112 = (obj[cljs.core.first.call(null,path)]);
var G__24113 = cljs.core.rest.call(null,path);
obj = G__24112;
path = G__24113;
continue;
} else {
...
var _STAR_ = (function (accum,p__24114){
var vec__24115 = p__24114;
var bit = cljs.core.nth.call(null,vec__24115,(0),null);
var protocol = cljs.core.nth.call(null,vec__24115,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24118){
var vec__24119 = p__24118;
var ns = cljs.core.nth.call(null,vec__24119,(0),null);
var name = cljs.core.nth.call(null,vec__24119,(1),null);
var selector = cljs.core.nth.call(null,vec__24119,(2),null);
...
var post_process = (function (p__24123){
var vec__24124 = p__24123;
var munged_name = cljs.core.nth.call(null,vec__24124,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24124,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24122_SHARP_){
return (obj[cljs.core.first.call(null,p1__24122_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1587042616461
