...
}catch (e29465){var _e = e29465;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___29468 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___29468)){
var seen_errors_29469 = temp__5733__auto___29468;
if(cljs.core.truth_(seen_errors_29469.has(self))){
} else {
seen_errors_29469.add(self);

var temp__5735__auto___29470 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___29470)){
var sense_29471 = temp__5735__auto___29470;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29471)].join(''));
} else {
}
}
} else {
