...
var G__23767 = devtools.prefs.pref.call(null,v);
v = G__23767;
continue;
} else {
return v;
...
}catch (e23770){var _e__23430__auto__ = e23770;
return false;
}})();
...
}catch (e23774){var _e__23430__auto__ = e23774;
return false;
}})();
...
}catch (e23776){var _e__23430__auto__ = e23776;
return false;
}}
}
});
...
var vec__23778 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__23778,(0),null);
var name = cljs.core.nth.call(null,vec__23778,(1),null);
...
return cljs.core.some.call(null,(function (p1__23781_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23781_SHARP_);
}),template);
});
