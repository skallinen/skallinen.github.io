...
var len__4789__auto___29654 = arguments.length;
var i__4790__auto___29655 = (0);
while(true){
if((i__4790__auto___29655 < len__4789__auto___29654)){
args__4795__auto__.push((arguments[i__4790__auto___29655]));

var G__29656 = (i__4790__auto___29655 + (1));
i__4790__auto___29655 = G__29656;
continue;
} else {
}
break;
...
/** @this {Function} */
(free_form.core.first_non_nil.cljs$lang$applyTo = (function (seq29653){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29653));
}));
...
var vec__29659 = free_form.core.extract_attributes.call(null,node,new cljs.core.Keyword("free-form","input","free-form/input",228451328));
var attributes = cljs.core.nth.call(null,vec__29659,(0),null);
var free_form_attributes = cljs.core.nth.call(null,vec__29659,(1),null);
var keys = cljs.core.nth.call(null,vec__29659,(2),null);
var map__29662 = free_form_attributes;
...
var value_on = cljs.core.get.call(null,map__29662__$1,new cljs.core.Keyword(null,"value-on","value-on",793040241));
var error_on = cljs.core.get.call(null,map__29662__$1,new cljs.core.Keyword(null,"error-on","error-on",-1977855177));
var extra_error_keys = cljs.core.get.call(null,map__29662__$1,new cljs.core.Keyword(null,"extra-error-keys","extra-error-keys",1784896497));
var on_change_fn = (function (p1__29657_SHARP_){
return on_change.call(null,keys,free_form.core.extract_event_value.call(null,p1__29657_SHARP_));
});
var value_on__$1 = (function (){var or__4185__auto__ = value_on;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__29664 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(attributes);
...
var value = (function (){var G__29665 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(attributes);
...
return cljs.core.assoc.call(null,node,free_form.util.attributes_index,(function (){var G__29666 = attributes;
var G__29666__$1 = cljs.core.assoc.call(null,G__29666,new cljs.core.Keyword(null,"on-change","on-change",-732046149),on_change_fn)
;
var G__29666__$2 = cljs.core.assoc.call(null,G__29666__$1,value_on__$1,value)
;
var G__29666__$3 = (cljs.core.truth_((function (){var and__4174__auto__ = error_on;
if(cljs.core.truth_(and__4174__auto__)){
return input_errors;
} else {
return and__4174__auto__;
}
})())?cljs.core.assoc.call(null,G__29666__$2,error_on,clojure.string.join.call(null," ",input_errors)):G__29666__$2);
if(cljs.core.truth_((function (){var and__4174__auto__ = extra_error_keys;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.some.call(null,(function (p1__29658_SHARP_){
return cljs.core.get_in.call(null,errors,p1__29658_SHARP_);
}),extra_error_keys);
} else {
return and__4174__auto__;
}
})())){
return cljs.core.assoc.call(null,G__29666__$3,error_on," ");
} else {
return G__29666__$3;
}
})());
...
var vec__29671 = free_form.core.extract_attributes.call(null,node,new cljs.core.Keyword("free-form","error-class","free-form/error-class",159754118));
var attributes = cljs.core.nth.call(null,vec__29671,(0),null);
var re_attributes = cljs.core.nth.call(null,vec__29671,(1),null);
var keys = cljs.core.nth.call(null,vec__29671,(2),null);
return cljs.core.assoc.call(null,node,free_form.util.attributes_index,((cljs.core.not_any_QMARK_.call(null,(function (p1__29669_SHARP_){
return cljs.core.get_in.call(null,errors,p1__29669_SHARP_);
}),cljs.core.conj.call(null,new cljs.core.Keyword(null,"extra-keys","extra-keys",-1845607319).cljs$core$IFn$_invoke$arity$1(re_attributes),keys)))?attributes:cljs.core.update.call(null,attributes,new cljs.core.Keyword(null,"class","class",-2030961996),(function (p1__29670_SHARP_){
...
})()),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29670_SHARP_)].join('');
}))));
}
});
...
var vec__29675 = free_form.core.extract_attributes.call(null,node,new cljs.core.Keyword("free-form","error-message","free-form/error-message",-1957745210));
var attributes = cljs.core.nth.call(null,vec__29675,(0),null);
var _ = cljs.core.nth.call(null,vec__29675,(1),null);
var keys = cljs.core.nth.call(null,vec__29675,(2),null);
var temp__5733__auto__ = cljs.core.get_in.call(null,errors,keys);
if(cljs.core.truth_(temp__5733__auto__)){
var errors__$1 = temp__5733__auto__;
return cljs.core.vec.call(null,cljs.core.concat.call(null,cljs.core.drop_last.call(null,cljs.core.assoc.call(null,node,free_form.util.attributes_index,attributes)),cljs.core.map.call(null,(function (p1__29674_SHARP_){
return cljs.core.conj.call(null,cljs.core.get.call(null,node,(2)),p1__29674_SHARP_);
}),errors__$1)));
} else {
return null;
}
...
var attrs_29679 = cljs.core.get.call(null,node,free_form.util.attributes_index);
if(cljs.core.truth_(((cljs.core.map_QMARK_.call(null,attrs_29679))?cljs.core.some.call(null,(function (p1__29678_SHARP_){
return cljs.core._EQ_.call(null,"free-form",cljs.core.namespace.call(null,p1__29678_SHARP_));
}),cljs.core.keys.call(null,attrs_29679)):false))){
...
return free_form.core.bind_error_messages.call(null,errors__$1,p1__29682_SHARP_);
}),clojure.walk.postwalk.call(null,(function (p1__29681_SHARP_){
return free_form.core.bind_error_class.call(null,errors__$1,p1__29681_SHARP_);
}),clojure.walk.postwalk.call(null,(function (p1__29680_SHARP_){
return free_form.core.bind_input.call(null,values,errors__$1,on_change,p1__29680_SHARP_);
}),html__$1)));
});
return clojure.walk.postwalk.call(null,(function (p1__29683_SHARP_){
return free_form.core.warn_of_leftovers.call(null,p1__29683_SHARP_);
}),cljs.core.reduce.call(null,(function (p1__29685_SHARP_,p2__29684_SHARP_){
return free_form.extension.extension.call(null,p2__29684_SHARP_,p1__29685_SHARP_);
...
//# sourceMappingURL=core.js.map?rel=1587042623999
