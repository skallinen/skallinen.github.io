...
var G__34635 = cljs.core.next(xs);
var G__34636 = cljs.core.next(ys);
xs = G__34635;
ys = G__34636;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__34597 = val;
var G__34598 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34597,G__34598) : f.call(null,G__34597,G__34598));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__34599 = val__$1;
var G__34600 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34599,G__34600) : f.call(null,G__34599,G__34600));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__34601 = val__$1;
var G__34602 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__34601,G__34602) : f.call(null,G__34601,G__34602));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__34648 = cljs.core.next(es);
var G__34649 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__34648;
tcoll__$1 = G__34649;
continue;
} else {
...
var G__34653 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__34654 = cljs.core.next(es);
ret = G__34653;
es = G__34654;
continue;
} else {
