...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__34772_SHARP_,p2__34771_SHARP_){
return p2__34771_SHARP_.toUpperCase();
}));
...
var G__34773 = o;
helix.impl.props.goog$module$goog$object.set(G__34773,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__34798 = cljs.core.rest(m);
var G__34799 = (function (){var entry = cljs.core.first(m);
...
var G__34788 = o1;
helix.impl.props.goog$module$goog$object.extend(G__34788,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34789_SHARP_){
if(cljs.core.map_QMARK_(p1__34789_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__34789_SHARP_);
} else {
return p1__34789_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__34805 = cljs.core.rest(m);
var G__34806 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__34811 = cljs.core.rest(m);
var G__34812 = (function (){var entry = cljs.core.first(m);
