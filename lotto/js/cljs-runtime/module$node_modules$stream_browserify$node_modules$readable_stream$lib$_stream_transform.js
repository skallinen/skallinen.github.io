shadow$provide.module$node_modules$stream_browserify$node_modules$readable_stream$lib$_stream_transform=function(global,require,module,exports){function afterTransform(er,data){var ts=this._transformState;ts.transforming=!1;var cb=ts.writecb;if(!cb)return this.emit("error",Error("write callback called multiple times"));ts.writechunk=null;ts.writecb=null;null!=data&&this.push(data);cb(er);er=this._readableState;er.reading=!1;(er.needReadable||er.length<er.highWaterMark)&&this._read(er.highWaterMark)}
...
function prefinish(){var _this=this;"function"===typeof this._flush?this._flush(function(er,data){done(_this,er,data)}):done(this,null,null)}function done(stream,er,data){if(er)return stream.emit("error",er);null!=data&&stream.push(data);if(stream._writableState.length)throw Error("Calling transform done when ws.length !\x3d 0");if(stream._transformState.transforming)throw Error("Calling transform done when still transforming");return stream.push(null)}module.exports=Transform;var Duplex=require("module$node_modules$stream_browserify$node_modules$readable_stream$lib$_stream_duplex");
...
//# sourceMappingURL=module$node_modules$stream_browserify$node_modules$readable_stream$lib$_stream_transform.js.map
